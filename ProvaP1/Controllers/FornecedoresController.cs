...
namespace ProvaP1.Controllers
{
    ...
    public class FornecedoresController : ControllerBase
    {
        ...
        public FornecedoresController(ProvaP1Context context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<Fornecedor>>> GetFornecedor()
        {
          if (_context.Fornecedor == null)
          {
            ...
            return await _context.Fornecedor.Include(f => f.Endereco).ToListAsync();
        }
        ...
        public async Task<ActionResult<Fornecedor>> GetFornecedor(int id)
        {
          if (_context.Fornecedor == null)
          {
            ...
            var fornecedor = await _context.Fornecedor.Include(f => f.Endereco).Where(f => f.Id == id).FirstOrDefaultAsync();
        ...
        public async Task<ActionResult<Fornecedor>> PostFornecedor(Fornecedor fornecedor)
        {
          if (_context.Fornecedor == null)
          {
              return Problem("Entity set 'ProvaP1Context.Fornecedor'  is null.");
          }
